 ...
 * @since 1.4.2
 */
public class LikePredicateClause extends AbstractPredicateClause {
    ...
    public LikePredicateClause(@Nonnull String expression, @Nonnull String value, @Nonnull MatchType matchType) {
    ...
    protected String buildHql() {
        return String.format("%s LIKE :%s", expression, VARIABLE_NAME);
    }
