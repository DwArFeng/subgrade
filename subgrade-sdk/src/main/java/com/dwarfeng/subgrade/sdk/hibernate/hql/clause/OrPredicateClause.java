 ...
 * @since 1.4.2
 */
public class OrPredicateClause extends AbstractPredicateClause {
    ...
    public OrPredicateClause(@Nonnull Collection<PredicateClause> predicateClauses) {
