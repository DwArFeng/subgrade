 ...
 * @since 2.0.0
 */
public final class CacheMessages {
     ...
     * @return 解析后的消息。
     */
    public static String message(CacheMessageKey key, Object... args) {
     ...
     * @return 解析后的消息。
     */
    public static String message(Locale locale, CacheMessageKey key, Object... args) {
    ...
    enum Catalog {
        ...
        SDK("com.dwarfeng.subgrade.cache.sdk.i18n.messages"),
        IMPL("com.dwarfeng.subgrade.cache.impl.i18n.messages");

        private final MessageCatalog messageCatalog;

        Catalog(String baseName) {
            this.messageCatalog = MessageCatalog.of(CacheMessages.class, baseName);
        }
