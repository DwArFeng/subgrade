...
public final class ExpressionMessages {
     ...
     * @return 解析后的消息。
     */
    public static String message(ExpressionMessageKey key, Object... args) {
     ...
     * @return 解析后的消息。
     */
    public static String message(Locale locale, ExpressionMessageKey key, Object... args) {
    ...
    enum Catalog {
        ...
        STACK("com.dwarfeng.subgrade.expression.stack.i18n.messages"),
        SDK("com.dwarfeng.subgrade.expression.sdk.i18n.messages");

        private final MessageCatalog messageCatalog;

        Catalog(String baseName) {
            this.messageCatalog = MessageCatalog.of(ExpressionMessages.class, baseName);
        }
