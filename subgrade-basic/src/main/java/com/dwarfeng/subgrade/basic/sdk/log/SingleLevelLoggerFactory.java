package com.dwarfeng.subgrade.basic.sdk.log;
...
public final class SingleLevelLoggerFactory {
     ...
     */
    public static SingleLevelLogger newInstance(@NotNull Logger delegate, @NotNull LogLevel logLevel) {
        return switch (logLevel) {
            case DEBUG -> new DebugSingleLevelLogger(delegate);
            case INFO -> new InfoSingleLevelLogger(delegate);
            case WARN -> new WarnSingleLevelLogger(delegate);
            case ERROR -> new ErrorSingleLevelLogger(delegate);
        };
    }
     ...
     */
    public static Map<LogLevel, SingleLevelLogger> newInstanceMap(@NotNull Logger delegate) {
