package com.dwarfeng.subgrade.basic.sdk.bean.dto;
...
public final class PagingUtil {
     ...
     */
    @Deprecated
    public record IntIndexBounds(int beginIndex, int endIndex) {
    }
     ...
     */
    @Deprecated
    public record LongIndexBounds(long beginIndex, long endIndex) {
    }
    ...
    public static <U extends Bean, V extends Bean> PagedData<V> transform(
            @NotNull PagedData<U> pagedData, @NotNull BeanTransformer<U, V> transformer
    ) {
    ...
    public static <U extends Bean, V extends Bean> PagedData<U> reverseTransform(
            @NotNull PagedData<V> pagedData, @NotNull BeanTransformer<U, V> transformer
    ) {
