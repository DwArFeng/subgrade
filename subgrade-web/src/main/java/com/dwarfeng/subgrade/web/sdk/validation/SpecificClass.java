package com.dwarfeng.subgrade.web.sdk.validation;
...
public @interface SpecificClass {
    ...
    String message() default "{com.dwarfeng.subgrade.web.validation.specific_class.message}";
    ...
    class SpecificClassConstraintValidator implements ConstraintValidator<SpecificClass, Object> {
        ...
        public boolean isValid(Object value, ConstraintValidatorContext context) {
            ...
            try {
                ...
                LOGGER.warn(WebMessages.message(WebMessageKey.LOG_VALIDATION_UNEXPECTED), e);
                return false;
            }
        }
    }
