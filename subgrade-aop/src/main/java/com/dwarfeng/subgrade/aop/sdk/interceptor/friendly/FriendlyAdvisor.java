package com.dwarfeng.subgrade.aop.sdk.interceptor.friendly;
...
public class FriendlyAdvisor implements ApplicationContextAware, EmbeddedValueResolverAware {
    ...
    @Around("@annotation(com.dwarfeng.subgrade.aop.sdk.interceptor.friendly.FriendlyList) || " +
            "@annotation(com.dwarfeng.subgrade.aop.sdk.interceptor.friendly.Friendly) || " +
            "@within(com.dwarfeng.subgrade.aop.sdk.interceptor.friendly.FriendlyList) || " +
            "@within(com.dwarfeng.subgrade.aop.sdk.interceptor.friendly.Friendly)")
