package com.dwarfeng.subgrade.aop.sdk.interceptor;
...
public final class AdvisorUtil {
     ...
     */
    public static <T extends Annotation> T directClassAnnotation(ProceedingJoinPoint pjp, Class<T> annotationClass) {
     ...
     */
    public static <T extends Annotation> T[] directClassAnnotations(ProceedingJoinPoint pjp, Class<T> annotationClass) {
     ...
     */
    public static <T extends Annotation> T directMethodAnnotation(ProceedingJoinPoint pjp, Class<T> annotationClass) {
