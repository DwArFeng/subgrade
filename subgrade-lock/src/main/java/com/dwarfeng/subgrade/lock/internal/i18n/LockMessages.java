...
public final class LockMessages {
     ...
     * @return 解析后的消息。
     */
    public static String message(LockMessageKey key, Object... args) {
     ...
     * @return 解析后的消息。
     */
    public static String message(Locale locale, LockMessageKey key, Object... args) {
    ...
    enum Catalog {
        ...
        SDK("com.dwarfeng.subgrade.lock.sdk.i18n.messages"),
        IMPL("com.dwarfeng.subgrade.lock.impl.i18n.messages");

        private final MessageCatalog messageCatalog;

        Catalog(String baseName) {
            this.messageCatalog = MessageCatalog.of(LockMessages.class, baseName);
        }
