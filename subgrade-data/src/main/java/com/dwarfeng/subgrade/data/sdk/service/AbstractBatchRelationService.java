...
import com.dwarfeng.subgrade.data.stack.service.BatchRelationService;
...
public abstract class AbstractBatchRelationService<PK extends Key, CK extends Key> implements
    ...
    public AbstractBatchRelationService(@NotNull ServiceExceptionMapper sem, @NotNull LogLevel exceptionLogLevel) {
        this.sem = sem;
