...
public class MybatisEntireLookupDao<E extends Entity<?>> implements EntireLookupDao<E> {
    ...
    public MybatisEntireLookupDao(@NotNull SqlSessionTemplate template, @NotNull String namespace) {
    ...
    public MybatisEntireLookupDao(
            ...
            @NotNull String entireLookupId,
            @NotNull String entirePagingId,
            @NotNull String entireCountId) {
