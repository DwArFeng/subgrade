...
//     */
//    public void setCollation(@NotNull Collation collation) {
...
//     * @param type       列的类型。
//     */
//    public void addColumn(@NotNull String columnName, @NotNull String type) {
...
//            @NotNull String columnName, @NotNull String type, String defaultValue, Charset characterSet,
...
//     */
//    public void addIndex(@NotNull String name, @NotNull IndexType indexType, @NotNull String... columnNames) {
...
//            @NotNull String name, @NotNull IndexType indexType, IndexStorage indexStorage,
//            Integer keyBlockSize, String parser, @NotNull String... columnNames) {
...
//    public void setIndexLength(@NotNull String indexName, @NotNull String columnName, Integer length) {
...
//     */
//    @SuppressWarnings("unchecked")
//    public void setIndexAsc(@NotNull String indexName, @NotNull String... columnNames) {
...
//     */
//    @SuppressWarnings("unchecked")
//    public void setIndexDesc(@NotNull String indexName, @NotNull String... columnNames) {
//        List<String> columnNameList = Arrays.asList(columnNames);
//        makeSureIndexExists(indexName);
//        makeSureAllColumnExists(columnNameList);
//        Map<String, Object> customDefinition = indexDefinitionMap.get(indexName).getCustomDefinition();
...
//            @NotNull String foreignKeyName, String refSchemaName, @NotNull String refTableName,
//            @NotNull List<String> refColumnNames, @NotNull List<String> columnNames) {
...
//    public void addForeignKey(
//            @NotNull String foreignKeyName, String refSchemaName, @NotNull String refTableName,
//            @NotNull List<String> refColumnNames, @NotNull List<String> columnNames, ForeignKeyOption onUpdate,
