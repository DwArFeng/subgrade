...
import com.dwarfeng.subgrade.data.sdk.jdbc.processor.BaseProcessor;
...
public class JdbcBaseDao<K extends Key, E extends Entity<K>> implements BaseDao<K, E> {
    ...
    public JdbcBaseDao(@NotNull JdbcTemplate template, @NotNull BaseProcessor<K, E> processor) {
    ...
    public void setProcessor(@NotNull BaseProcessor<K, E> processor) {
        this.processor = processor;
    }
}
