 ...
 * @since 1.5.4
 */
public abstract class AbstractPresetLookupService<E extends Entity<?>> implements PresetLookupService<E> {
    ...
    public AbstractPresetLookupService(@NotNull ServiceExceptionMapper sem, @NotNull LogLevel exceptionLogLevel) {
        this.sem = sem;
    ...
    public PagedData<E> lookup(String preset, Object[] objs) throws ServiceException {
        try {
            return doLookup(preset, objs);
        } catch (Exception e) {
            throw ServiceExceptionHelper.logParse("查询预设对应的所有实体时发生异常", exceptionLogLevel, e, sem);
        }
    }
     ...
     * @see #lookup(String, Object[])
     */
    protected abstract PagedData<E> doLookup(String preset, Object[] objs) throws Exception;

    @Override
    public List<E> lookupAsList(String preset, Object[] objs) throws ServiceException {
        try {
            return doLookupAsList(preset, objs);
        } catch (Exception e) {
            throw ServiceExceptionHelper.logParse("查询预设对应的所有实体时发生异常", exceptionLogLevel, e, sem);
        }
    }
     ...
     * @see #lookup(String, Object[])
     */
    protected abstract List<E> doLookupAsList(String preset, Object[] objs) throws Exception;

    @Override
    public PagedData<E> lookup(String preset, Object[] objs, PagingInfo pagingInfo) throws ServiceException {
        try {
            return doLookup(preset, objs, pagingInfo);
        } catch (Exception e) {
            throw ServiceExceptionHelper.logParse("查询预设对应的分页实体时发生异常", exceptionLogLevel, e, sem);
        }
    }
     ...
     * 所有系统参数的值均可以在 <code>com.dwarfeng.subgrade.data.sdk.configuration.SystemPropertyConstants</code> 类中找到。
     *
     * <p>
     * 在该接口的实践中发现，
     ...
     * @see #lookup(String, Object[])
     */
    protected abstract PagedData<E> doLookup(String preset, Object[] objs, PagingInfo pagingInfo) throws Exception;

    @Override
    public List<E> lookupAsList(String preset, Object[] objs, PagingInfo pagingInfo) throws ServiceException {
        try {
            return doLookupAsList(preset, objs, pagingInfo);
        } catch (Exception e) {
            throw ServiceExceptionHelper.logParse("查询预设对应的分页实体时发生异常", exceptionLogLevel, e, sem);
        }
    }
     ...
     * @return 实体组成的列表。
     * @throws Exception 方法执行时发生的任何异常。
     * @see #lookup(String, Object[], PagingInfo)
     */
    protected abstract List<E> doLookupAsList(String preset, Object[] objs, PagingInfo pagingInfo) throws Exception;

    @Override
    public E lookupFirst(String preset, Object[] objs) throws ServiceException {
        try {
            return doLookupFirst(preset, objs);
        } catch (Exception e) {
            throw ServiceExceptionHelper.logParse("查询预设对应的首个实体时发生异常", exceptionLogLevel, e, sem);
        }
    }
     ...
     * @see #lookup(String, Object[])
     */
    protected abstract E doLookupFirst(String preset, Object[] objs) throws Exception;

    @Override
    public int lookupCount(String preset, Object[] objs) throws ServiceException {
        try {
            return doLookupCount(preset, objs);
        } catch (Exception e) {
            throw ServiceExceptionHelper.logParse("查询预设对应的实体数量时发生异常", exceptionLogLevel, e, sem);
        }
    }
     ...
     * @see #lookup(String, Object[])
     */
    protected abstract int doLookupCount(String preset, Object[] objs) throws Exception;
    ...
    public String toString() {
        return "AbstractPresetLookupService{" +
                "sem=" + sem +
