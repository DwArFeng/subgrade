...
import com.dwarfeng.subgrade.data.sdk.service.AbstractPresetLookupService;
...
public class DaoOnlyPresetLookupService<E extends Entity<?>> extends AbstractPresetLookupService<E> {
    ...
    public void setDao(@NotNull PresetLookupDao<E> dao) {
        this.dao = dao;
    }
