...
import com.dwarfeng.subgrade.data.sdk.jdbc.handle.WriteHandle;
...
public class PhoenixBatchWriteProcessor<E extends Entity<?>> implements BatchWriteProcessor<E> {
    ...
    public PhoenixBatchWriteProcessor(
            @NotNull TableDefinition tableDefinition, @NotNull WriteHandle<E> handle) {
    ...
    public void setHandle(@NotNull WriteHandle<E> handle) {
        this.handle = handle;
    }
}
