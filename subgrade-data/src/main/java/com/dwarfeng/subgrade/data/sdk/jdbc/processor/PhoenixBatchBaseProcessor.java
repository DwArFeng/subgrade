...
import com.dwarfeng.subgrade.data.sdk.jdbc.handle.BaseHandle;
...
public class PhoenixBatchBaseProcessor<K extends Key, E extends Entity<K>> implements BatchBaseProcessor<K, E> {
    ...
    public PhoenixBatchBaseProcessor(
            @NotNull TableDefinition tableDefinition, @NotNull BaseHandle<K, E> handle) {
    ...
    public void setHandle(@NotNull BaseHandle<K, E> handle) {
        this.handle = handle;
    }
}
