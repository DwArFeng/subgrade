...
import com.dwarfeng.subgrade.data.sdk.jdbc.handle.ResultHandle;
...
public class PhoenixEntireLookupProcessor<E extends Entity<?>> implements EntireLookupProcessor<E> {
    ...
    public PhoenixEntireLookupProcessor(
            @NotNull TableDefinition tableDefinition, @NotNull ResultHandle<E> resultHandle) {
    ...
    public void setHandle(@NotNull ResultHandle<E> handle) {
        this.handle = handle;
    }
}
