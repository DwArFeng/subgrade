...
import com.dwarfeng.subgrade.data.stack.service.BatchWriteService;
...
public abstract class AbstractBatchWriteService<E extends Entity<?>> implements BatchWriteService<E> {
    ...
    public AbstractBatchWriteService(@NotNull ServiceExceptionMapper sem, @NotNull LogLevel exceptionLogLevel) {
        this.sem = sem;
