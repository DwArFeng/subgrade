package com.dwarfeng.subgrade.data.sdk.database.definition;
...
public class PhoenixHelper {
     ...
     */
    public static void setSchemaName(@NotNull TableDefinition tableDefinition, String schemaName) {
        tableDefinition.setSchemaName(schemaName);
    }

    public static void setTableName(@NotNull TableDefinition tableDefinition, String tableName) {
        tableDefinition.setTableName(tableName);
    }

    public static void addColumn(
            @NotNull TableDefinition tableDefinition, @NotNull String columnName, @NotNull String type
    ) {
     ...
     */
    public static ColumnNullable getColumnNullable(@NotNull ColumnDefinition columnDefinition) {
     ...
     * @return 指定列定义的 默认值。
     */
    public static String getColumnDefaultValue(@NotNull ColumnDefinition columnDefinition) {
        return (String) columnDefinition.getProperty(CUSTOM_DEFAULT, null);
    }

    public static void setPrimaryKey(@NotNull TableDefinition tableDefinition, @NotNull String... columnNames) {
        setPrimaryKey(tableDefinition, Arrays.asList(columnNames), null, null, null);
    }

    public static void setPrimaryKey(
            @NotNull TableDefinition tableDefinition, @NotNull List<String> columnNames, List<String> ascColumnNames,
     ...
     * @return 升序列名称组成的集合。
     */
    public static Set<String> getPrimaryKeyAscColumnNames(@NotNull TableDefinition tableDefinition) {
     ...
     * @return 降序列名称组成的集合。
     */
    public static Set<String> getPrimaryKeyDescColumnNames(@NotNull TableDefinition tableDefinition) {
        OptionalDefinition primaryKeyOptionalDefinition = getPrimaryKeyOptionalDefinition(tableDefinition);
        @SuppressWarnings("unchecked")
        Set<String> property = (Set<String>) primaryKeyOptionalDefinition.getProperty(
     ...
     */
    public static String getPrimaryKeyRowTimestampColumn(@NotNull TableDefinition tableDefinition) {
        OptionalDefinition primaryKeyOptionalDefinition = getPrimaryKeyOptionalDefinition(tableDefinition);
        return (String) primaryKeyOptionalDefinition.getProperty(CUSTOM_ROW_TIMESTAMP_COLUMN, null);
    }

    private static OptionalDefinition getPrimaryKeyOptionalDefinition(@NotNull TableDefinition tableDefinition) {
    ...
    public static void setTableSaltBuckets(@NotNull TableDefinition tableDefinition, Integer val) {
    ...
    public static Integer getTableSaltBuckets(@NotNull TableDefinition tableDefinition) {
     ...
     */
    public static void setTableDisableWal(@NotNull TableDefinition tableDefinition, Boolean val) {
        tableDefinition.putProperty(CUSTOM_DISABLE_WAL, val);
    }

    public static Boolean getTableDisableWal(@NotNull TableDefinition tableDefinition) {
    ...
    public static void setTableImmutableRows(@NotNull TableDefinition tableDefinition, Boolean val) {
        tableDefinition.putProperty(CUSTOM_IMMUTABLE_ROWS, val);
    }

    public static Boolean getTableImmutableRows(@NotNull TableDefinition tableDefinition) {
     ...
     */
    public static void setTableMultiTelnet(@NotNull TableDefinition tableDefinition, Boolean val) {
        tableDefinition.putProperty(CUSTOM_MULTI_TELNET, val);
    }

    public static Boolean getTableMultiTelnet(@NotNull TableDefinition tableDefinition) {
     ...
     */
    public static void setTableDefaultColumnFamily(@NotNull TableDefinition tableDefinition, String val) {
    ...
    public static String getTableDefaultColumnFamily(@NotNull TableDefinition tableDefinition) {
     ...
     */
    public static void setTableStoreNulls(@NotNull TableDefinition tableDefinition, Boolean val) {
        tableDefinition.putProperty(CUSTOM_STORE_NULLS, val);
    }

    public static Boolean getTableStoreNulls(@NotNull TableDefinition tableDefinition) {
    ...
    public static void setTableTransactional(@NotNull TableDefinition tableDefinition, Boolean val) {
        tableDefinition.putProperty(CUSTOM_TRANSACTIONAL, val);
    }

    public static Boolean getTableTransactional(@NotNull TableDefinition tableDefinition) {
     ...
     */
    public static void setTableUpdateCacheFrequency(
            @NotNull TableDefinition tableDefinition, UpdateCacheFrequency val
    ) {
     ...
     */
    public static void setTableUpdateCacheFrequency(@NotNull TableDefinition tableDefinition, Long val) {
    ...
    public static Object getTableUpdateCacheFrequency(@NotNull TableDefinition tableDefinition) {
     ...
     */
    public static void setTableAppendOnlySchema(@NotNull TableDefinition tableDefinition, Boolean val) {
        tableDefinition.putProperty(CUSTOM_APPEND_ONLY_SCHEMA, val);
    }

    public static Boolean getTableAppendOnlySchema(@NotNull TableDefinition tableDefinition) {
     ...
     */
    public static void setTableAutoPartitionSeq(@NotNull TableDefinition tableDefinition, String val) {
        if (Objects.isNull(val) || val.isEmpty()) {
    ...
    public static String getTableAutoPartitionSeq(@NotNull TableDefinition tableDefinition) {
     ...
     */
    public static void setTableGuidPostsWidth(@NotNull TableDefinition tableDefinition, Integer val) {
        if (Objects.nonNull(val) && val < 0) {
    ...
    public static Integer getTableGuidPostsWidth(@NotNull TableDefinition tableDefinition) {
     ...
     */
    public static void setTableSplitPoint(@NotNull TableDefinition tableDefinition, String... columnNames) {
    ...
    public static List<String> getTableSplitPoint(@NotNull TableDefinition tableDefinition) {
        @SuppressWarnings("unchecked")
    ...
    public static void addIndex(
            @NotNull TableDefinition tableDefinition, @NotNull String indexName, @NotNull List<String> columnNames) {
    ...
    public static List<OptionalDefinition> getIndexes(@NotNull TableDefinition tableDefinition) {
        return tableDefinition.getOptionalDefinitions(OPTIONAL_TYPE_INDEX);
    }

    public static IndexType getIndexType(@NotNull OptionalDefinition optionalDefinition) {
        return (IndexType) optionalDefinition.getProperty(CUSTOM_INDEX_TYPE, null);
    }

    public static List<String> getIndexContextColumnNames(@NotNull OptionalDefinition optionalDefinition) {
        @SuppressWarnings("unchecked")
     ...
     * @return 升序列名称组成的集合。
     */
    public static Set<String> getIndexAscColumnNames(@NotNull OptionalDefinition optionalDefinition) {
        @SuppressWarnings("unchecked")
     ...
     * @return 降序列名称组成的集合。
     */
    public static Set<String> getIndexDescColumnNames(@NotNull OptionalDefinition optionalDefinition) {
        @SuppressWarnings("unchecked")
        Set<String> property =
                (Set<String>) optionalDefinition.getProperty(CUSTOM_DESC_COLUMNS, Collections.emptySet());
        return property;
    }

    public static List<String> getIndexIncludeColumnNames(@NotNull OptionalDefinition optionalDefinition) {
        @SuppressWarnings("unchecked")
        List<String> property =
    ...
    public static IndexAsyncType getIndexAsyncType(@NotNull OptionalDefinition optionalDefinition) {
    ...
    public static void setIndexSaltBuckets(
            @NotNull TableDefinition tableDefinition, @NotNull String indexName, Integer val) {
    ...
    public static Integer getIndexSaltBuckets(@NotNull OptionalDefinition optionalDefinition) {
    ...
    public static void setIndexDisableVal(
            @NotNull TableDefinition tableDefinition, @NotNull String indexName, Boolean val) {
        makeSureIndexExists(tableDefinition, indexName);
        tableDefinition.getOptionalDefinition(indexName).putProperty(CUSTOM_DISABLE_WAL, val);
    }

    public static Boolean getIndexDisableWal(@NotNull OptionalDefinition optionalDefinition) {
    ...
    public static Boolean getIndexImmutableRows(@NotNull OptionalDefinition optionalDefinition) {
    ...
    public static Boolean getIndexMultiTelnet(@NotNull OptionalDefinition optionalDefinition) {
    ...
    public static void setIndexDefaultColumnFamily(
            @NotNull TableDefinition tableDefinition, @NotNull String indexName, String val) {
        makeSureIndexExists(tableDefinition, indexName);
        if (Objects.isNull(val) || val.isEmpty()) {
            throw new IllegalArgumentException("DEFAULT_COLUMN_FAMILY 不能为 null 或空字符串");
        }
    ...
    public static String getIndexDefaultColumnFamily(@NotNull OptionalDefinition optionalDefinition) {
    ...
    public static Boolean getIndexStoreNulls(@NotNull OptionalDefinition optionalDefinition) {
    ...
    public static Boolean getIndexTransactional(@NotNull OptionalDefinition optionalDefinition) {
    ...
    public static void setIndexUpdateCacheFrequency(
            @NotNull TableDefinition tableDefinition, @NotNull String indexName, UpdateCacheFrequency val) {
        makeSureIndexExists(tableDefinition, indexName);
     ...
     */
    public static void setIndexUpdateCacheFrequency(
            @NotNull TableDefinition tableDefinition, @NotNull String indexName, Long val) {
        makeSureIndexExists(tableDefinition, indexName);
        if (Objects.nonNull(val) && val < 0) {
            throw new IllegalArgumentException("UPDATE_CACHE_FREQUENCY 的取值应大于 0 " + val);
        }
    ...
    public static Object getIndexUpdateCacheFrequency(@NotNull OptionalDefinition optionalDefinition) {
    ...
    public static Boolean getIndexAppendOnlySchema(@NotNull OptionalDefinition optionalDefinition) {
    ...
    public static String getIndexAutoPartitionSeq(@NotNull OptionalDefinition optionalDefinition) {
    ...
    public static Integer getIndexGuidPostsWidth(@NotNull OptionalDefinition optionalDefinition) {
    ...
    public static void setIndexSplitPoint(
            @NotNull TableDefinition tableDefinition, @NotNull String indexName, String... columnNames) {
        makeSureIndexExists(tableDefinition, indexName);
        makeSureAllColumnExists(tableDefinition, Arrays.asList(columnNames));
        tableDefinition.getOptionalDefinition(indexName).putProperty(CUSTOM_SPLIT_POINT, Arrays.asList(columnNames));
    }

    public static List<String> getIndexSplitPoint(@NotNull OptionalDefinition optionalDefinition) {
        @SuppressWarnings("unchecked")
        List<String> property =
                (List<String>) optionalDefinition.getProperty(CUSTOM_SPLIT_POINT, Collections.emptyList());
        return property;
    }

    @SuppressWarnings("unchecked")
    public static List<ColumnDefinition> getPrimaryKeyColumns(@NotNull TableDefinition tableDefinition) {
    ...
    @SuppressWarnings("unchecked")
    public static List<ColumnDefinition> getNonPrimaryKeyColumns(@NotNull TableDefinition tableDefinition) {
        return (List<ColumnDefinition>) tableDefinition.getOrPutCache(
     ...
     */
    public static String getFullTableName(@NotNull TableDefinition tableDefinition) {
