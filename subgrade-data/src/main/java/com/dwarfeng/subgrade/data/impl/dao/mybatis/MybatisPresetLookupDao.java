...
import com.dwarfeng.subgrade.data.sdk.mybatis.PresetLookupInfo;
...
public class MybatisPresetLookupDao<E extends Entity<?>> implements PresetLookupDao<E> {
    ...
    public MybatisPresetLookupDao(@NotNull SqlSessionTemplate template, @NotNull String namespace) {
    ...
    public MybatisPresetLookupDao(
            ...
            @NotNull String presetLookupId,
            @NotNull String presetPagingId,
            @NotNull String presetCountId) {
