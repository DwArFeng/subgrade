...
import com.dwarfeng.subgrade.data.sdk.jdbc.handle.PresetLookupHandle;
import com.dwarfeng.subgrade.data.sdk.jdbc.handle.QueryInfo;
...
public class PhoenixPresetLookupProcessor<E extends Entity<?>> implements PresetLookupProcessor<E> {
    ...
    public PhoenixPresetLookupProcessor(
            @NotNull TableDefinition tableDefinition, @NotNull PresetLookupHandle<E> handle) {
    ...
    public void setHandle(@NotNull PresetLookupHandle<E> handle) {
        this.handle = handle;
    }
}
