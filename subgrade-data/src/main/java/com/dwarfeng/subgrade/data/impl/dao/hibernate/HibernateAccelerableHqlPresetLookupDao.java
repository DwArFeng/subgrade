 ...
 * 利用
 * {@link HibernateDaoFactory#newHqlPresetLookupDao(HibernateOperations, BeanTransformer, Class, PresetConditionMaker, NativeLookup)}
 * {@link HibernateDaoFactory#newHqlPresetLookupDaoWithChosenDialect(HibernateOperations, BeanTransformer, Class, PresetConditionMaker, List, String)}
 * {@link HibernateDaoFactory#newHqlPresetLookupDaoWithChosenDialect(HibernateOperations, BeanTransformer, Class, PresetConditionMaker, List, Class)}
 * 可以便捷地实现目标数据库可变时的本地加速查询判断逻辑。
 *
 * @author DwArFeng
 * @see HibernateDaoFactory#newHqlPresetLookupDao(HibernateOperations, BeanTransformer, Class, PresetConditionMaker, NativeLookup)
 * @see HibernateDaoFactory#newHqlPresetLookupDaoWithChosenDialect(HibernateOperations, BeanTransformer, Class, PresetConditionMaker, List, String)
 * @see HibernateDaoFactory#newHqlPresetLookupDaoWithChosenDialect(HibernateOperations, BeanTransformer, Class, PresetConditionMaker, List, Class)
 * @since 1.4.2
 */
