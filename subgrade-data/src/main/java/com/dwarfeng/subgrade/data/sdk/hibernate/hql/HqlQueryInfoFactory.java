...
public class HqlQueryInfoFactory {
    ...
    public static HqlQueryInfo buildQueryInfoFormCondition(HqlCondition condition) {
        ...
        if (!whereClauses.isEmpty()) {
            ...
            for (int i = 0; i < whereClauses.size(); i++) {
                ...
                hqlBuilder.append(paramReassignResult.hql());
                paramMap.putAll(paramReassignResult.paramMap());
    ...
    private record ParamReassignResult(@NotNull String hql, @NotNull Map<String, Object> paramMap) {
    }
