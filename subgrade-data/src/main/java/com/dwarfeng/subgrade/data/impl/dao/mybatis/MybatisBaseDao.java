...
public class MybatisBaseDao<K extends Key, E extends Entity<K>> implements BaseDao<K, E> {
    ...
    public MybatisBaseDao(@NotNull SqlSessionTemplate template, @NotNull String namespace) {
    ...
    public MybatisBaseDao(
            ...
            @NotNull String updateId,
            @NotNull String deleteId,
            @NotNull String existsId,
