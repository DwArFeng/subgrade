...
import com.dwarfeng.subgrade.data.sdk.mybatis.BatchRelationInfo;
import com.dwarfeng.subgrade.data.sdk.mybatis.RelationInfo;
...
public class MybatisBatchRelationDao<PK extends Key, CK extends Key> implements BatchRelationDao<PK, CK> {
    ...
    public MybatisBatchRelationDao(
            ...
            @NotNull String existsRelationId,
            @NotNull String addRelationId,
            @NotNull String deleteRelationId,
            @NotNull String existsAllRelationId,
            @NotNull String existsNonRelationId,
            @NotNull String batchAddRelationId,
            @NotNull String batchDeleteRelationId) {
