...
import com.dwarfeng.dutil.basic.impl.model.DefaultReferenceModel;
import com.dwarfeng.dutil.basic.impl.model.DelegateKeyListModel;
import com.dwarfeng.dutil.basic.impl.model.DelegateMapModel;
...
public class TableDefinition {
     ...
     */
    public void addColumnDefinition(@NotNull ColumnDefinition columnDefinition) {
    ...
    public void addOptionalDefinition(@NotNull OptionalDefinition optionalDefinition) {
    ...
    public List<OptionalDefinition> getOptionalDefinitions(String type) {
        return optionalDefinitionList.stream().filter(
                d -> Objects.equals(type, d.getType())).toList();
    }
