...
public final class DataMessages {
     ...
     * @return 解析后的消息。
     */
    public static String message(DataMessageKey key, Object... args) {
     ...
     * @return 解析后的消息。
     */
    public static String message(Locale locale, DataMessageKey key, Object... args) {
    ...
    enum Catalog {
        ...
        STACK("com.dwarfeng.subgrade.data.stack.i18n.messages"),
        SDK("com.dwarfeng.subgrade.data.sdk.i18n.messages"),
        IMPL("com.dwarfeng.subgrade.data.impl.i18n.messages");

        private final MessageCatalog messageCatalog;

        Catalog(String baseName) {
            this.messageCatalog = MessageCatalog.of(DataMessages.class, baseName);
        }
