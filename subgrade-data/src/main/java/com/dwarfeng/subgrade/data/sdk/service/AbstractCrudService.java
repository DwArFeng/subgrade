...
import com.dwarfeng.subgrade.data.stack.service.CrudService;
...
public abstract class AbstractCrudService<K extends Key, E extends Entity<K>> implements CrudService<K, E> {
    ...
    public AbstractCrudService(@NotNull ServiceExceptionMapper sem, @NotNull LogLevel exceptionLogLevel) {
        this.sem = sem;
