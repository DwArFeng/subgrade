package com.dwarfeng.subgrade.data.sdk.service.custom.operation;
...
public interface CrudOperation<K extends Key, E extends Entity<K>> {
     ...
     *
     * <p>
     * 实现该方法时需要判断指定的主键是否存在，不过不存在，请抛出异常或者返回 null。
     *
     * @param key 指定的主键。
     * @return 指定的主键对应的实体。
     * @throws Exception 操作过程中的任何异常。
     ...
     *
     * <p>
     * 该方法被调用时可以保证入口参数拥有服务中不存在的主键。
     *
     * @param element 指定的元素，可以保证其主键不为 null 且服务中不存在。
     ...
     *
     * <p>
     * 该方法被调用时可以保证入口参数拥有服务中存在的主键。
     *
     * @param element 指定的元素，可以保证其主键不为 null 且服务中存在。
     * @throws Exception 操作过程中的任何异常。
     */
     ...
     *
     * <p>
     * 该方法被调用时可以保证服务中存在入口参数。
     *
     * @param key 指定的元素对应的主键，可以保证不为 null 且服务中存在。
     * @throws Exception 操作过程中的任何异常。
     */
