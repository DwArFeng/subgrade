package com.dwarfeng.subgrade.data.stack.dao;
 ...
 * 该接口是服务 {@link com.dwarfeng.subgrade.data.stack.service.WriteService} 的配套接口。
 *
 * @author DwArFeng
 * @see com.dwarfeng.subgrade.data.stack.service.WriteService
 * @since 1.1.0
 */
