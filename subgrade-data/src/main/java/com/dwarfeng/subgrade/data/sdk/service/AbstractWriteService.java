...
import com.dwarfeng.subgrade.data.stack.service.WriteService;
 ...
 * @since 1.5.4
 */
public abstract class AbstractWriteService<E extends Entity<?>> implements WriteService<E> {
    ...
    public AbstractWriteService(@NotNull ServiceExceptionMapper sem, @NotNull LogLevel exceptionLogLevel) {
        this.sem = sem;
